            ...
            <div className="row">
                ...
                <div  className="col" key={index}>
                    <div className="itrImg">
                        ...
                        <Checkbox className= "checkbox" checked={intrest.check} onChange = {()=>{
                            const newIntrest = intrestsData.filter((last) =>last.name !==intrest.name)
                            newIntrest.push({ name: intrest.name , check:!intrest.check , intrImg:intrest.intrImg });
